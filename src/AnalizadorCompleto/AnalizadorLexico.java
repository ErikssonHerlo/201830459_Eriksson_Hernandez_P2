...
public class AnalizadorLexico {
     public static final String boleano = "VERDADEROFALSO";
    public static final String[] boleano2 = {"VERDADERO", "FALSO"};
    public static final String reservada = "variable,entero,decimal,booleano,cadena,si,sino,mientras,hacer,funcion,principal,retornar,vacio,carácter,para,imprimir";
